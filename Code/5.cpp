...
int main()
{
    ...
    cout << linklist1.tail->data << endl; //此说明指向了尾节点
    linklist1.mydelete(10);
    cout << linklist1.tail->data << endl;
    linklist1.mydelete(8);
    cout << linklist1.tail->data << endl;
    return 0;
}
